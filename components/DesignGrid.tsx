    ...
    <div className="flex flex-col gap-6 w-full">
        <div className="text-center">
            <div className="inline-flex items-center gap-3 bg-gray-800/50 px-4 py-2 rounded-full">
                <div className="bg-amber-500 text-gray-900 rounded-full h-8 w-8 flex items-center justify-center font-bold text-lg flex-shrink-0">3</div>
                <h2 className="text-xl font-bold">Elige tu Diseño Favorito</h2>
            </div>
             <p className="text-gray-400 mt-2">Estos diseños fueron generados por IA usando tu producto y logotipo.</p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
        {designs.map((design, index) => (
          <div
            key={index}
            className="relative rounded-lg overflow-hidden cursor-pointer border-4 border-transparent hover:border-amber-400 transition-all duration-200 group aspect-square"
